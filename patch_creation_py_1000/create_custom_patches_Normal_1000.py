...
train_paths = ["/scratch/ss4yd/chrc_data_patches_norm/train/Normal/"]
...
for key in list(images_by_folder.keys()):
    temp = key.replace('chrc_data_patches', 'chrc_data_patches_1000')
...
score_df.to_csv('/scratch/ss4yd/Normal_train_1000.csv')
